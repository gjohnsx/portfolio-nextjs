    ...
    <Popover className="relative bg-primary">
      <div className="flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10 container">
        ...
        <div className="-mr-2 -my-2 md:hidden">
          <Popover.Button className="bg-primary-focus rounded-md p-2 inline-flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-inset focus:ring-secondary">
        ...
        <div className="hidden md:flex-1 md:flex md:items-center md:justify-between">
          <Popover.Group as="nav" className="flex space-x-10">
              ...
              {({ open }) => (
                <>
                  ...
                  >
                    ...
                    <ChevronDownIcon
                      className={classNames(
                        open ? 'text-accent-focus' : 'text-accent',
            ...
            <a href="#" className="text-base font-medium text-primary-content hover:text-primary-focus">
              Pricing
            </a>
            
            <Link href='/posts'>
              <a className="text-base font-medium text-primary-content hover:text-primary-focus">
                Blog
              </a>
            </Link>
                ...
                <>
                  ...
                  >
                    ...
                    <ChevronDownIcon
                      className={classNames(
                        open ? 'text-accent-focus' : 'text-accent',
                        'ml-2 h-5 w-5 group-hover:text-primary-content'
                      )}
                      aria-hidden="true"
                    />
                  </Popover.Button>
          ...
          <div className="flex items-center md:ml-12">
            ...
            <Link href='/contact'>
                <a
                className="ml-8 btn btn-secondary"
                >
                Contact
                </a>
            </Link>
      ...
      >
        ...
        {/* Mobile Menu */}
        <Popover.Panel focus className="bg-slate-700 z-50 absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
              ...
              <div className="mt-6">
                <nav className="grid gap-6">
                  {solutions.map((item) => (
                    ...
                    >
                      <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-primary text-accent">
                        <item.icon className="h-6 w-6" aria-hidden="true" />
                      </div>
